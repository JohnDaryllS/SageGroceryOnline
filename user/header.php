...
<body class="d-flex flex-column min-vh-100">
    <div class="wrapper">
        <?php if (!isset($_SESSION['username'])) { ?>
            ...
            <?php } else { $rows = $db->query("SELECT * FROM users WHERE id='$_SESSION[id]'"); ?>
                <div class="container-fluid header">
                    <div class="row">
                        <div class="col-6">
                            <a <a href="../action/logout.php" class="btn btn-secondary">Log Out</a>
                            <a href="orderhistory.php" class="btn btn-primary">Order History</a>
                        </div>
                        <div class="col-6 text-end">
                            <h5>Welcome <a href="profile.php" class="btn btn-warning"><?php echo $_SESSION['username'];?></a></h5>
                        </div>
                    </div>
                </div>
                <?php } ?>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarContent">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="shopping-basket.php">Shopping Basket</a>
                        </li>
                        <li class="nav-item">
